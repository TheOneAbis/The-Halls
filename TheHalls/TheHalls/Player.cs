...
namespace TheHalls
{
    class Player : GameObject
    {
        ...
        public Player(Vector2 worldLoc, Vector2 size, Texture2D[] spriteSheets, Texture2D arcImageSword, Texture2D arcImageSpear,Texture2D weaponImage, GameOver gameOver) : base(worldLoc, size, spriteSheets, 6, new Vector2(60, 108), new Vector2(0, 0), 77) //Old player values: base(worldLoc, size, spriteSheets, 6, new Vector2(18, 18), new Vector2(7, 7), 32)
        {
